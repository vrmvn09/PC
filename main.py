...
def commands(message):
    if message.text == '/start':
        ...
        bot.send_message(message.chat.id, HELP_MESSAGE_RU if LANGUAGE == 'RU' else HELP_MESSAGE_EN,
        ...
        try:
            ...
            bot.send_message(message.chat.id,
                             'ошибка,не добавил в автозагрузку|PS(МБ не сменил имя файла оно стандартно Название)')
